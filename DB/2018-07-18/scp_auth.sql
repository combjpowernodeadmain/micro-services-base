...
insert  into `oauth_client_details`(`client_id`,`resource_ids`,`client_secret`,`scope`,`authorized_grant_types`,`web_server_redirect_uri`,`authorities`,`access_token_validity`,`refresh_token_validity`,`additional_information`,`autoapprove`,`description`,`crt_user_name`,`crt_user_id`,`crt_time`,`upd_user_name`,`upd_user_id`,`upd_time`,`is_deleted`,`is_disabled`) values ('client','','client','read','password,refresh_token,authorization_code','http://localhost:4040/sso/login',NULL,3600,2592000,'{}','true',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),('vue',NULL,'vue','read','password,refresh_token','http://localhost:9527/#/',NULL,14400,2592000,'{}','true','',NULL,NULL,NULL,'Mr.AG','1','2018-03-28 20:43:14',NULL,NULL);
