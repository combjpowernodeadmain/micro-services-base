...
CREATE TABLE `area_grid_member` (
  ...
  `grid_member` varchar(36) DEFAULT NULL COMMENT '网格成员',
...
CREATE TABLE `attendance_info` (
  ...
  `tenant_id` varchar(36) DEFAULT NULL COMMENT '租户ID',
  `depart_id` varchar(36) DEFAULT NULL COMMENT '部门ID',
  `crt_username` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COMMENT='考勤信息';

/*Data for the table `attendance_info` */

insert  into `attendance_info`(`id`,`longitude`,`latitude`,`map_info`,`crt_user_name`,`crt_user_id`,`crt_time`,`tenant_id`,`depart_id`,`crt_username`) values (1,123.123,123.123,'asdfd','aaa','1111','2018-08-01 09:00:00',NULL,'111','test'),(2,123.123,123.123,'asdfd','aaa','1111','2018-08-01 12:00:00',NULL,'111','test'),(3,123.123,123.123,'asdff','aaa','1111','2018-08-01 18:00:00',NULL,'111','test'),(4,123.123,123.123,'dddd','aaa','1111','2018-07-31 09:00:00',NULL,'111','test'),(5,123.123,123.123,'dddd','aaa','1111','2018-07-31 18:00:00',NULL,'111','test'),(6,123.123,123.123,'ffff','aaa','1111','2018-07-30 09:00:00',NULL,'111','test');
