...
public class WfProcTaskBean implements Serializable {
	...
	private String procOrgpermission;
	private String procDeptpermission;
	private String procSelfpermission1;
	private String procSelfdata1;
	private String procSelfpermission2;
	private String procSelfdata2;
	private String procSelfpermission3;
	private String procSelfdata3;
	private String procSelfpermission4;
	private String procSelfdata4;
	private String procSelfpermission5;
	private String procSelfdata5;
	...
	private String procTenantpermission;
	...
	public String getProcSelfProperties() {
		return procSelfProperties;
	}
	...
	public String getProcOrgpermission() {
		return procOrgpermission;
	}

	public void setProcOrgpermission(String procOrgpermission) {
		this.procOrgpermission = procOrgpermission;
	}

	public String getProcDeptpermission() {
		return procDeptpermission;
	}

	public void setProcDeptpermission(String procDeptpermission) {
		this.procDeptpermission = procDeptpermission;
	}
	...
	public String getProcSelfpermission2() {
		return procSelfpermission2;
	}

	public void setProcSelfpermission2(String procSelfpermission2) {
		this.procSelfpermission2 = procSelfpermission2;
	}

	public String getProcSelfdata2() {
		return procSelfdata2;
	}

	public void setProcSelfdata2(String procSelfdata2) {
		this.procSelfdata2 = procSelfdata2;
	}

	public String getProcSelfpermission3() {
		return procSelfpermission3;
	}

	public void setProcSelfpermission3(String procSelfpermission3) {
		this.procSelfpermission3 = procSelfpermission3;
	}

	public String getProcSelfdata3() {
		return procSelfdata3;
	}

	public void setProcSelfdata3(String procSelfdata3) {
		this.procSelfdata3 = procSelfdata3;
	}

	public String getProcSelfpermission4() {
		return procSelfpermission4;
	}

	public void setProcSelfpermission4(String procSelfpermission4) {
		this.procSelfpermission4 = procSelfpermission4;
	}

	public String getProcSelfdata4() {
		return procSelfdata4;
	}

	public void setProcSelfdata4(String procSelfdata4) {
		this.procSelfdata4 = procSelfdata4;
	}

	public String getProcSelfpermission5() {
		return procSelfpermission5;
	}

	public void setProcSelfpermission5(String procSelfpermission5) {
		this.procSelfpermission5 = procSelfpermission5;
	}

	public String getProcSelfdata5() {
		return procSelfdata5;
	}

	public void setProcSelfdata5(String procSelfdata5) {
		this.procSelfdata5 = procSelfdata5;
	}

	public String getProcTenantpermission() {
		return procTenantpermission;
	}

	public void setProcTenantpermission(String procTenantpermission) {
		this.procTenantpermission = procTenantpermission;
	}
