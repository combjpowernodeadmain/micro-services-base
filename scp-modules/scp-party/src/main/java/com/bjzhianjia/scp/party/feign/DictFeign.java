package com.bjzhianjia.scp.party.feign;
...
public interface DictFeign {
    ...
    Map<String, String> getDictValues(@PathVariable("code") String code);
    ...
    Map<String, String> getDictIds(@PathVariable("code") String code);
    ...
    Map<String, String> getDictValueByID(@PathVariable("id") String id);
    ...
    Map<String, String> getDictIdByCode(@PathVariable("code") String code,
    ...
    Map<String, String> getByCode(@PathVariable("code") String code);
