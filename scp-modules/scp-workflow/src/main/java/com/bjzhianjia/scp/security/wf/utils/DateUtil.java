package com.bjzhianjia.scp.security.wf.utils;
...
public class DateUtil {
     ...
     * @throws IqbException
     */
    public static int getTime(String date, int datePartten, int convertType) throws WorkflowException {
    ...
    private static Calendar parseDate(String date, int rank)
        ...
        if (rank >= 3 && rank <= 7) {
            ...
            throw new WorkflowException(BaseEnumResults.BASE00020002);
        }
    }
     ...
     * @throws WorkflowException
     */
    public static Calendar toDate(String date, int type) throws WorkflowException {
        try {
            switch (type) {
            ...
            throw new WorkflowException(BaseEnumResults.BASE00020001, nfe);
        } catch (StringIndexOutOfBoundsException sioobe) {
            throw new WorkflowException(BaseEnumResults.BASE00020001, sioobe);
        } catch (RuntimeException re) {
            throw new WorkflowException(BaseEnumResults.BASE00000002, re);
        }
    }
