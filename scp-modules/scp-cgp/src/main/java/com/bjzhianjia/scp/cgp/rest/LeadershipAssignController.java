...
public class LeadershipAssignController extends BaseController<LeadershipAssignBiz,LeadershipAssign,Integer> {
	...
	@ApiOperation("添加单个对象")
	public ObjectRestResponse<LeadershipAssignVo> add(@RequestBody @Validated @ApiParam(name="待添加对象实例")LeadershipAssignVo vo,BindingResult bindingResult){
	...
	@ApiOperation("更新单个对象")
	public ObjectRestResponse<LeadershipAssign> updateCache(@RequestBody @Validated @ApiParam(name="待更新对象实例")LeadershipAssign leadershipAssign,BindingResult bindingResult){
		ObjectRestResponse<LeadershipAssign> restResult=new ObjectRestResponse<>();
		if (bindingResult.hasErrors()) {
			restResult.setStatus(400);
			restResult.setMessage(bindingResult.getAllErrors().get(0).getDefaultMessage());
	...
	@ApiOperation("更新单个对象")
	public ObjectRestResponse<LeadershipAssign> update(@RequestBody @Validated @ApiParam(name="待更新对象实例")LeadershipAssignVo leadershipAssign,BindingResult bindingResult){
		ObjectRestResponse<LeadershipAssign> restResult=new ObjectRestResponse<>();
		if (bindingResult.hasErrors()) {
			restResult.setStatus(400);
			restResult.setMessage(bindingResult.getAllErrors().get(0).getDefaultMessage());
	...
	public TableResultResponse<LeadershipAssignVo> list(@RequestParam(defaultValue = "1") @ApiParam(name = "当前页") int page,
		...
		TableResultResponse<LeadershipAssignVo> list = leadershipAssignService.getList(leadershipAssign, page, limit, startTime, endTime);
		return list;
	}
	...
	public ObjectRestResponse<PublicOpinion> remove(
		...
		leadershipAssignBiz.remove(ids);
		result.setStatus(200);
		result.setMessage("成功");
		return result;
	}
