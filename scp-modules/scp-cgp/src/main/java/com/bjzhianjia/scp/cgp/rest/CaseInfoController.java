...
public class CaseInfoController extends BaseController<CaseInfoBiz, CaseInfo, Integer> {
    ...
    @ApiOperation("更新单个对象")
    private ObjectRestResponse<CaseInfo> update(
        @RequestBody @Validated @ApiParam(name = "待更新对象实例") CaseInfo caseInfo,
    ...
    public TableResultResponse<CaseInfo> page(
        ...
        TableResultResponse<CaseInfo> restResult =
            caserInfoService.getList(caseInfo, page, limit, false);
    ...
    public TableResultResponse<CaseInfo> pageNoFinish(@PathVariable("id") Integer id,
        ...
        TableResultResponse<CaseInfo> restResult =
            caserInfoService.getList(caseInfo, page, limit, true);
    ...
    @ApiOperation("获取单个对象")
    public ObjectRestResponse<CaseInfo> get(
        @PathVariable("id") @ApiParam(name = "待查询对象ID") Integer id) {
    ...
    public TableResultResponse<JSONObject> getAllTasks(@RequestBody JSONObject objs,
        HttpServletRequest request) {
    ...
    public ObjectRestResponse<JSONObject> completeProcess(@RequestBody JSONObject objs,
        HttpServletRequest request) {
    ...
    public ObjectRestResponse<JSONObject> getUserToDoTask(@RequestBody JSONObject objs,
        HttpServletRequest request) {
    ...
    public ObjectRestResponse<JSONObject> endProcessInstance(@RequestBody JSONObject objs,
