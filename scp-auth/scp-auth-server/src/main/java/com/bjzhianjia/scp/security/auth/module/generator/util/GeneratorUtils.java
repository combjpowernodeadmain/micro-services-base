...
package com.bjzhianjia.scp.security.auth.module.generator.util;
...
public class GeneratorUtils {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        map.put("package", "com.bjzhianjia.scp.security.generate");
        map.put("author", "bjzhianjia");
        map.put("email", "dev@bjzhianjia.com");
        map.put("description", "auto generator");
        // 决定服务名\maven模块名\主文件夹名
        map.put("clientId", "scp-demo-generator");
